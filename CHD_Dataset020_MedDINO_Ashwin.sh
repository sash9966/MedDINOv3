#!/bin/bash
# =============================================================================
#  CHD_Dataset020_MedDINO_Ashwin.sh
#  Dataset020FanweiDataandImageCHD_HU — MedDINOv3 2D + 3D Ashwin_3d_inflation
#
...
#SBATCH --output=/scratch/users/sastocke/nnunet_CHD/logs/D020-MedDINO-Ashwin_%j.out
#SBATCH --error=/scratch/users/sastocke/nnunet_CHD/logs/D020-MedDINO-Ashwin_%j.err
...
CKPT_DIR="${nnUNet_results}/${DATASET_NAME}/.checkpoints/CHD_Dataset020_MedDINO_Ashwin"
START_TS=$(date +%s)
...
print_banner() {
    echo ""
    echo "╔══════════════════════════════════════════════════════════════════╗"
    echo "║  CHD_Dataset020_MedDINO_Ashwin.sh  — START                     ║"
    echo "╠══════════════════════════════════════════════════════════════════╣"
...
print_footer() {
    ...
    echo ""
    echo "╔══════════════════════════════════════════════════════════════════╗"
    echo "║  CHD_Dataset020_MedDINO_Ashwin.sh  — COMPLETE                  ║"
    echo "╠══════════════════════════════════════════════════════════════════╣"
    printf "║  %-66s ║\n" "Date/Time    : $(date '+%Y-%m-%d %H:%M:%S')"
