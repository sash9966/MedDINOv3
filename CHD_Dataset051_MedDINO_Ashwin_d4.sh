#!/bin/bash
# =============================================================================
#  CHD_Dataset051_MedDINO_Ashwin_d4.sh
#  Dataset051_imageCHD_DiseaseLandmarksV2 — MedDINOv3 3D Ashwin
#  channel-averaging inflation, d=4
#
...
#  top of the Dataset030 label set — everything else is identical). Same token
...
# =============================================================================
#SBATCH --job-name=D051-MedDINO-A4
...
#SBATCH --output=/scratch/users/sastocke/nnunet_CHD/logs/D051-MedDINO-A4_%j.out
#SBATCH --error=/scratch/users/sastocke/nnunet_CHD/logs/D051-MedDINO-A4_%j.err
...
CKPT_DIR="${nnUNet_results}/${DATASET_NAME}/.checkpoints/CHD_Dataset051_MedDINO_Ashwin_d4"
START_TS=$(date +%s)
...
echo ""
echo "╔══════════════════════════════════════════════════════════════════╗"
echo "║  CHD_Dataset051_MedDINO_Ashwin_d4.sh — START                   ║"
echo "╠══════════════════════════════════════════════════════════════════╣"
...
echo ""
echo "╔══════════════════════════════════════════════════════════════════╗"
echo "║  CHD_Dataset051_MedDINO_Ashwin_d4.sh — COMPLETE                ║"
echo "╠══════════════════════════════════════════════════════════════════╣"
