#!/bin/bash
# =============================================================================
#  CHD_Dataset030_MedDINO.sh
#  Dataset030_imageCHD_HU — MedDINOv3 2D + 3D weight-inflated, 1000 epochs
#
...
#SBATCH --output=/scratch/users/sastocke/nnunet_CHD/logs/D030-MedDINO_%j.out
#SBATCH --error=/scratch/users/sastocke/nnunet_CHD/logs/D030-MedDINO_%j.err
...
CKPT_DIR="${nnUNet_results}/${DATASET_NAME}/.checkpoints/CHD_Dataset030_MedDINO"
START_TS=$(date +%s)
...
print_banner() {
    echo ""
    echo "╔══════════════════════════════════════════════════════════════════╗"
    echo "║  CHD_Dataset030_MedDINO.sh  — START                            ║"
    echo "╠══════════════════════════════════════════════════════════════════╣"
...
print_footer() {
    ...
    echo ""
    echo "╔══════════════════════════════════════════════════════════════════╗"
    echo "║  CHD_Dataset030_MedDINO.sh  — COMPLETE                         ║"
    echo "╠══════════════════════════════════════════════════════════════════╣"
    printf "║  %-66s ║\n" "Date/Time    : $(date '+%Y-%m-%d %H:%M:%S')"
...
# Markers are shared so the Ashwin job can skip
# if this job already ran the 2D folds.
# ─────────────────────────────────────────────
echo "================================================================"
