#!/bin/bash
# =============================================================================
#  CHD_Dataset001_MedDINO_Ashwin.sh
#  Dataset001_all_imageCHD — MedDINOv3 2D + 3D Ashwin_3d_inflation, 1000 epochs
#
...
#
#  Inflation strategy differs from centering/average (CHD_Dataset001_MedDINO.sh):
#    Ashwin strategy first collapses 3 input channels into their sum, then
#    redistributes equally across all channels before tiling along depth.
#    See inflate_weights_3d_ashwin.py for details.
#
#  RESUME SUPPORT
...
#SBATCH --output=/scratch/users/sastocke/nnunet_CHD/logs/D001-MedDINO-Ashwin_%j.out
#SBATCH --error=/scratch/users/sastocke/nnunet_CHD/logs/D001-MedDINO-Ashwin_%j.err
...
CKPT_DIR="${nnUNet_results}/${DATASET_NAME}/.checkpoints/CHD_Dataset001_MedDINO_Ashwin"
START_TS=$(date +%s)
...
print_banner() {
    echo ""
    echo "╔══════════════════════════════════════════════════════════════════╗"
    echo "║  CHD_Dataset001_MedDINO_Ashwin.sh  — START                     ║"
    echo "╠══════════════════════════════════════════════════════════════════╣"
...
print_footer() {
    ...
    echo ""
    echo "╔══════════════════════════════════════════════════════════════════╗"
    echo "║  CHD_Dataset001_MedDINO_Ashwin.sh  — COMPLETE                  ║"
    echo "╠══════════════════════════════════════════════════════════════════╣"
    printf "║  %-66s ║\n" "Date/Time    : $(date '+%Y-%m-%d %H:%M:%S')"
