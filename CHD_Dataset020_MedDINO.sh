#!/bin/bash
# =============================================================================
#  CHD_Dataset020_MedDINO.sh
#  Dataset020FanweiDataandImageCHD_HU — MedDINOv3 2D + 3D weight-inflated, 1000 epochs
#
#  Combined Fanwei + imageCHD dataset. Best candidate for Slicer clinical
#  deployment due to largest training set.
#
...
#SBATCH --output=/scratch/users/sastocke/nnunet_CHD/logs/D020-MedDINO_%j.out
#SBATCH --error=/scratch/users/sastocke/nnunet_CHD/logs/D020-MedDINO_%j.err
...
print_banner() {
    echo ""
    echo "╔══════════════════════════════════════════════════════════════════╗"
    echo "║  CHD_Dataset020_MedDINO.sh  — START                            ║"
    echo "╠══════════════════════════════════════════════════════════════════╣"
...
print_footer() {
    ...
    echo ""
    echo "╔══════════════════════════════════════════════════════════════════╗"
    echo "║  CHD_Dataset020_MedDINO.sh  — COMPLETE                         ║"
    echo "╠══════════════════════════════════════════════════════════════════╣"
    printf "║  %-66s ║\n" "Date/Time    : $(date '+%Y-%m-%d %H:%M:%S')"
